...
use crate::mem::mmu::{AccessPermissions, AttributeFields, MemAttributes};
use super::{Granule512MiB, Granule64KiB};
use core::convert;
use tock_registers::{
...
const NUM_LVL2_TABLES: usize = crate::bsp::board::mmu::KernelAddrSpace::SIZE >> Granule512MiB::SHIFT;
        ...
        let mut desc = match attribute_fields.mem_attributes {
            MemAttributes::CacheableDRAM => {
                STAGE1_PAGE_DESCRIPTOR::SH::InnerShareable
                    + STAGE1_PAGE_DESCRIPTOR::AttrIndx.val(super::mair::NORMAL)
            }
            MemAttributes::Device => {
                STAGE1_PAGE_DESCRIPTOR::SH::OuterShareable
                    + STAGE1_PAGE_DESCRIPTOR::AttrIndx.val(super::mair::DEVICE)
            }
        };
            ...
            *l2_entry =
            ...
            for (l3_nr, l3_entry) in self.lvl3[l2_nr].iter_mut().enumerate() {
                ...
                let (phys_output_addr, attribute_fields) =
                    crate::bsp::board::mmu::virt_mem_layout().virt_addr_properties(virt_addr)?;
