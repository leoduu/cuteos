...
static DRIVER_MANAGER: Raspi4DriverManager = Raspi4DriverManager {
    drivers: [
        &self::GPIO,
        &self::PL011_UART
    ]
...
impl DriverManager for Raspi4DriverManager {
...
const GENERIC_TIMER_INTR: usize = 40;
