...
register_structs! {
    ...
    // Redistributor_Register_For_SGIs_And_PPIs_Block
        ...
        (0x10084 => IGROUPRE: [ReadWrite<u32>; 2]),
        (0x1008C => _reserved4),
        (0x10100 => ISENABLER0: ReadWrite<u32>),
        (0x10104 => ISENABLERE: [ReadWrite<u32>; 2]),
        (0x1010C => _reserved5),
        (0x10180 => ICENABLER0: ReadWrite<u32>),
        (0x10184 => ICENABLERE: [ReadWrite<u32>; 2]),
        (0x1018C => _reserved6),
        (0x10200 => ISPENDR0: ReadWrite<u32>),
        (0x10204 => ISPENDRE: [ReadWrite<u32>; 2]),
        (0x1020C => _reserved7),
        (0x10280 => ICPENDR0: ReadWrite<u32>),
        (0x10284 => ICPENDRE: [ReadWrite<u32>; 2]),
        (0x1028C => _reserved8),
        (0x10300 => ISACTIVER0: ReadWrite<u32>),
        (0x10304 => ISACTIVERE: [ReadWrite<u32>; 2]),
        (0x1030C => _reserved9),
        (0x10380 => ICACTIVER0: ReadWrite<u32>),
        (0x10384 => ICACTIVERE: [ReadWrite<u32>; 2]),
        (0x1038C => _reserved10),
        (0x10400 => IPRIORITYR: [ReadWrite<u32>; 8]),
        (0x10420 => IPRIORITYRE: [ReadWrite<u32>; 16]),
        (0x10460 => _reserved11),
        (0x10C00 => ICFGR0: ReadWrite<u32>),
        (0x10C04 => ICFGR1: ReadWrite<u32>),
        (0x10C08 => ICFGRE: [ReadWrite<u32>; 4]),
        (0x10C18 => _reserved12),
        (0x10D00 => IGRPMODR0: ReadWrite<u32>),
        (0x10D04 => IGRPMODRE: [ReadWrite<u32>; 2]),
        (0x10D0C => _reserved13),
...
impl GICInner {
    ...
    // Redistributor configuration 
        ...
        // aff3:aff2:aff1:aff0
        let a = (((_mpidr_el1 >> 32) & 0xF) << 24) | (_mpidr_el1 & 0x0FFF);
    ...
    // SPI, PPI and SGI configuration
        ...
        // Config PPIs as Group1NS
        self.gicr[cpu_num].IGROUPR0.set(!0x0);
        self.gicr[cpu_num].IGRPMODR0.set(0x0);
        self.gicr[cpu_num].ISENABLER0.set(!0x0);  //Enable PPI 
        self.gicr[cpu_num].ICENABLER0.set(0x0);


        // Config SPIs as Group1NS
        ...
        // Enable
        for i in 0..2 {
            self.gicr[cpu_num].IGROUPRE[i].set(!0x0);
            self.gicr[cpu_num].IGRPMODRE[i].set(0x0);          //SGIs|PPIs Group1NS 
            self.gicr[cpu_num].ISENABLERE[i].set(!0x0);  //Enable SGI 0 
            self.gicr[cpu_num].ICENABLERE[i].set(0x0);
        }
    }
